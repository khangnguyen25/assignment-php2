...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $this->renderViewClient('products.create', [
    ...
    public function store()
    {
        ...
        if ($validation->fails()) {
            ...
            header('Location: ' . url('client/products/create'));
            exit;
        } else {
            $data = [
            ...
            header('Location: ' . url('client/products'));
            exit;
        }
    }
    ...
    public function edit($id)
    {
        ...
        $this->renderViewClient('products.edit', [
            'product' => $product,
            'categoryPluck' => $categoryPluck,
        ]);
    }
    ...
    public function update($id)
    {
        ...
        if ($validation->fails()) {
            ...
            header('Location: ' . url("client/products/$id/edit"));
            exit;
        } else {
            $data = [
                'category_id'   => $_POST['category_id'],
